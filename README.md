...
Обеспечьте вывод данных заданной точности с использованием манипуляторов **std::setw** и **std::setprecision**. Вычисления и вывод данных должны быть разделены (то есть не должны выполняться в одной функции).
